...
class Node(object):
    """node in graph store node id,node parent 'pi' node color for detect search node distance for a node to given
    source """
...
if __name__ == '__main__':
    ...
    graph = GraphWeight(9)
    graph.add_node_weight((0, 1, 4), (1, 2, 8), (2, 3, 7), (3, 4, 9), (4, 5, 10), (5, 6, 2), (6, 7, 1), (7, 8, 7),
                          (7, 0, 8))
    ...
    graph.add_dw_edge((0, 1, 6), (0, 4, 7), (1, 2, 5), (1, 3, -4), (1, 4, 8), (2, 1, -2), (3, 2, 7), (3, 0, 2),
                      (4, 2, -3), (4, 3, 9))
    ...
    graph.add_dw_edge((0, 1, 5), (0, 2, 3), (1, 2, 2), (1, 3, 6), (2, 4, 4), (2, 5, 2), (3, 4, -1), (3, 5, 1),
                      (4, 5, -2))
    ...
    graph = Graph_Direct_Weight(5)
    graph.add_dw_edge((0, 1, 10), (0, 4, 5), (1, 2, 1), (1, 4, 2), (2, 3, 4), (3, 0, 7), (3, 2, 6), (4, 1, 3),
                      (4, 3, 9), (4, 3, 2))
    ...
    graph = Graph_Mat(5)
    graph.add_wd_edge((0, 1, 3), (0, 2, 8), (0, 4, -4), (1, 3, 1), (1, 4, 7), (2, 1, 4), (3, 2, -5), (3, 0, 2),
                      (4, 3, 6))
    ...
    graph.add_cap_edge((0, 1, 16), (0, 5, 13), (1, 2, 12), (1, 5, 10), (2, 5, 9), (2, 3, 20), (4, 2, 7), (4, 3, 4),
                       (5, 4, 14), (5, 1, 4))
